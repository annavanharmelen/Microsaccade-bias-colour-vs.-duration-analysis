# MICROSACCADE BIAS COLOUR VS. DURATION ANALYSIS
# ***[work in progress]***
Analysis scripts (in MATLAB) for the data acquired from the microsaccade-bias colour vs. duration experiment (in Python). For the experiment, see: [Microsaccade-bias-colour-vs.-duration-main]([https://github.com/annavanharmelen/Microsaccade-bias-duration-experiment](https://github.com/annavanharmelen/Microsaccade-bias-colour-vs.-duration-experiment)).
